...
describe('POST /contacts', () => {
  test('should ok when sending first name, last name, and email', async () => {
  ...
  // test('should throw when sending incorrect body', async () => {
  //   await request(app)
  //     .post('/contacts')
...
//       });
//   });
//   test('should 400 if not existed', async () => {
//     await request(app)
